...
# Sub-setting is done early on to help reduce memory requirements.
...
print("Assuming data files from the \"UCI HAR Dataset\" are available in the current directory with the same structure as in the downloaded archive.")
print("    Refer Data:")
